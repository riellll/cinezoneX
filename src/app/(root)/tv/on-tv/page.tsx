...
import { GetOnTvShow, GetTvRecommendations } from "@/lib/fetchData";
import { IoIosPlay } from "react-icons/io";
import { Metadata } from 'next'

export const metadata: Metadata = {
  title: 'Currently Airing TV Shows - The Cinizone Collection',
...
const page = async ({
  ...
  const { results: onTvShow, total_pages } = await GetOnTvShow(
    searchParams.page
  );
