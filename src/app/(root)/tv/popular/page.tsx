...
import { GetPopularShow, GetTvRecommendations } from "@/lib/fetchData";
import { IoIosPlay } from "react-icons/io";
import { Metadata } from 'next'

export const metadata: Metadata = {
  title: 'Popular TV Shows - The Cinizone Collection',
...
const page = async ({
  ...
  const { results: popularShow, total_pages } = await GetPopularShow(
    searchParams.page
  );
