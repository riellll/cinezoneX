  ...
  return (
    <>
      <button
          ...
          >
            <span className="hidden md:block text-base font-normal">Login</span>
            <BsArrowRight />{" "}
          </button>
      <Modal 
        isOpen={isOpen} 
      ...
      >
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1">Log in <span className='text-sm font-normal'>Apologies, the login functionality is still not operational.</span></ModalHeader>
              <ModalBody>
                <Input
                  autoFocus
                  endContent={
