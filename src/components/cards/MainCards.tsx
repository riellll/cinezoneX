...
const MainCards = () => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-6 sm:gap-5 items-center justify-between min-[320px]:grid-cols-2 min-[320px]:gap-3 min-[320px]:px-5 min-[320px]:mb-10 min-[320px]:mt-10">
        {list.map((item) => {
