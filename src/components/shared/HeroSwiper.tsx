      ...
      <div className="relative bg-[#141412]">
        ...
        >
          {homeSwiperImg.map((item, index) => (
            <SwiperSlide>
              <div className="bghero saturate-50 flex bg-[url('../../public/donbelle.webp')] bg-no-repeat bg-cover bg-center bg-gray-300 p-4 w-full h-screen">
                <div className="self-end flex flex-col w-full items-center sm:items-start text-gray-100 gap-3 pb-40 px-3">
                  <h1 className="text-2xl md:text-4xl font-medium dark:text-white saturate-200">
                    THE MARVELS
                  </h1>
                  <div className="flex flex-wrap text-base md:text-lg gap-5 saturate-200">
                    <p>rating</p>
                    <p>year</p>
                    <p>time</p>
                    <p>desc</p>
                  ...
                  <p className="hidden lg:block text-start text-base text-gray-400 max-w-4xl saturate-200">
